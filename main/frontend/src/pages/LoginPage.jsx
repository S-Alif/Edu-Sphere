                    ...
                    <div className="form-content py-8 px-4 lg:px-8">
                        ...
                        <form action="" className='pt-8 w-full'>
                            ...
                            <div className="w-full lg:w-1/2">
                                ...
                                <input type="email" className='form-control input input-bordered border-emerald-500 mt-4 mb-6 w-full' name='email' id='email' placeholder='enter your email' autoComplete='false' />
                            </div>

                            <div className="w-full lg:w-1/2">
                                <label htmlFor="pass" className='font-semibold'>Password</label>
                                <input type="password" className='form-control input input-bordered border-emerald-500 w-full mt-4' name='pass' id='pass' placeholder='enter your password' />
                            </div>
