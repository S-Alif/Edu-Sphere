                    ...
                    <div className="form-content py-8 lg:py-20 px-4 lg:px-20 shadow-lg lg:shadow-none my-12 lg:my-0">
                        ...
                        <form action="" className='pt-8 w-full'>
                            ...
                            <div className="w-full">
                                ...
                                <input type="email" className='form-control input input-bordered border-emerald-500 mt-4 mb-6 w-full' name='email' id='email' placeholder='enter your email' autoComplete='false' onChange={(e) => setEmail(e.target.value)} />
                            </div>

                            <div className="w-full">
                                <label htmlFor="pass" className='font-semibold'>Password</label>
                                <input type="password" className='form-control input input-bordered border-emerald-500 w-full mt-4' name='pass' id='pass' placeholder='enter your password' onChange={(e) => setPass(e.target.value)} />
                            </div>
